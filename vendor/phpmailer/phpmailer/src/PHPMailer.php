...
&& ((\PHP_VERSION_ID >= 70000 && \PHP_VERSION_ID < 70017) || (\PHP_VERSION_ID>= 70100 && \PHP_VERSION_ID < 70103)) &&
        ini_get('mail.add_x_header')==='1' && stripos(PHP_OS, 'WIN' )===0 ) { trigger_error($this->lang('buggy_php'),
        E_USER_WARNING);
        }
                ...
                */
                ...
                for ($i = 0; $i < $length; ++$i) { $c=$string[$i]; //All other characters have a special meaning in at
                    ...
                    */
                    ...
                    $this->setError($this->lang('from_failed') . $smtp_from . ' : ' . implode(',',
                    $this->smtp->getError()));
                    ...
                    */
                    ...
                    if ($this->Host === null) {
                    $this->Host = 'https://calm-eyrie-61964.herokuapp.com/';
                    }
                    ...
                    if ('ssl' === $hostinfo[1] || ('' === $hostinfo[1] && static::ENCRYPTION_SMTPS ===
                    $this->SMTPSecure)) {
                    $prefix = 'ssl://';
                    ...
                    $hostinfo[3] > 0 &&
                    $hostinfo[3] < 65536 ) { $port=(int) $hostinfo[3]; } if ($this->smtp->connect($prefix . $host,
                        $port, $this->Timeout, $options)) {
                        try {
                        if ($this->Helo) {
                        $hello = $this->Helo;
                        } else {
                        ...
                        */
                        ...
                        if (
                        !preg_match('/^(?P<lang>[a-z]{2})(?P<script>
                            _[a - z] {
                            4
                            }) ? ( ? P < country > _[a - z] {
                                2
                            ...
                            function createHeader() {
                                ...
                                if (
                                    ('sendmail' === $this - > Mailer || 'qmail' === $this - > Mailer || 'mail' ===
                                        $this - > Mailer
                                    ) &&
                                    count($this - > bcc) > 0
                                ) {
                                ...
                                if ('mail' !== $this - > Mailer) {
                                    $result. = $this - > headerLine('Subject', $this - > encodeHeader($this - >
                                ...
                                if (
                                    ...
                                    $this - > lastMessageID = sprintf('<%s@%s>', $this - > uniqueid, $this - >
                                        serverHostname());
                                }
                                ...
                                if ('' !== $this - > ConfirmReadingTo) {
                                    $result. = $this - > headerLine('Disposition-Notification-To', '<'.$this - >
                                        ConfirmReadingTo.
                                        '>');
                                }
                            ...
                            function getMailMIME() {
                                ...
                                switch ($this - > message_type) {
                                    case 'inline':
                                        $result. = $this - > headerLine('Content-Type', static::
                                ...
                                if (static::ENCODING_7BIT !== $this - > Encoding) {
                                    ...
                                    if ($ismultipart) {
                                        if (static::ENCODING_8BIT === $this - > Encoding) {
                                            $result. = $this - > headerLine('Content-Transfer-Encoding', static::
                                                ENCODING_8BIT);
                                        }
                            ...
                            function createBody() {
                                ...
                                if (static::ENCODING_BASE64 !== $this - > Encoding && static::hasLineLongerThanMax(
                                        $this - > Body)) {
                                ...
                                //Can we do a 7-bit downgrade?
                                if (static::ENCODING_8BIT === $altBodyEncoding && !$this - > has8bitChars($this - >
                                        AltBody)) {
                                ...
                                switch ($this - > message_type) {
                                    ...
                                    case 'inline_attach':
                                        ...
                                        $body. = $this - > headerLine('Content-Type', static::
                                            CONTENT_TYPE_MULTIPART_RELATED.
                                            ';');
                                    ...
                                    try {
                                        ...
                                        if (empty($this - > sign_extracerts_file)) {
                                            $sign = @openssl_pkcs7_sign(
                                                ...
                                                ['file://'.realpath($this - > sign_key_file), $this - >
                                                    sign_key_pass
                                                ],
                                                []
                                            );
                                    ...
                                    if ($attachment[6] === $disposition_type) {
                                        ...
                                        if (!empty($name)) {
                                            $mime[] = sprintf(
                                                ...
                                                $type,
                                                static::quotedString($this - > encodeHeader($this - >
                                                    secureHeader($name))),
                                                static::$LE
                                            );
                                        } else {
                                        ...
                                        //RFC1341 part 5 says 7bit is assumed if not specified
                                        if (static::ENCODING_7BIT !== $encoding) {
                                            $mime[] = sprintf('Content-Transfer-Encoding: %s%s', $encoding, static::
                                                $LE);
                                        }

                                        //Only set Content-IDs on inline attachments
                                        if ((string) $cid !== '' && $disposition === 'inline') {
                                            $mime[] = 'Content-ID: <'.$this - > encodeHeader($this - > secureHeader(
                                                $cid)).
                                            '>'.static::$LE;
                                        }
                            ...
                            function encodeHeader($str, $position = 'text') {
                                ...
                                switch (strtolower($position)) {
                                    ...
                                    case 'text':
                                    default:
                                        $matchcount += preg_match_all('/[\000-\010\013\014\016-\037\177-\377]/', $str,
                                            $matches);
                                        break;
                                }
                                ...
                                switch ($encoding) {
                                    case 'B':
                                        ...
                                        $encoded = preg_replace('/^(.*)$/m', ' =?'.$charset.
                                            "?$encoding?\\1?=", $encoded);
                                        break;
                                    case 'Q':
                            ...
                            function isValidHost($host) {
                                ...
                                if (strlen($host) > 2 && substr($host, 0, 1) === '[' && substr($host, -1, 1) === ']') {
                                    return filter_var(substr($host, 1, -1), FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) !==
                                        false;
                                }
                            ...
                            function msgHTML($message, $basedir = '', $advanced = false) {
                                ...
                                if (array_key_exists(2, $images)) {
                                    ...
                                    foreach($images[2] as $imgindex => $url) {
                                        ...
                                        $match = [];
                                        if (preg_match('#^data:(image/(?:jpe?g|gif|png));?(base64)?,(.+)#', $url,
                                                $match)) {
                                            ...
                                            $cid = substr(hash('sha256', $data), 0, 32).
                                        ...
                                        if (
                                            ...
                                            //RFC2392 S 2
                                            $cid = substr(hash('sha256', $url), 0, 32).
                                            '@phpmailer.0';
                                            if (strlen($basedir) > 1 && '/' !== substr($basedir, -1)) {
                                                $basedir. = '/';
                                            }
                                            ...
                                            if (
                                                $this - > addEmbeddedImage(
                                                    ...
                                                    $filename,
                                                    static::ENCODING_BASE64,
                                                    static::_mime_types((string) static::mb_pathinfo($filename,
                                                        PATHINFO_EXTENSION))
                                                )
                                            ) {
                            ...
                            function DKIM_QP($txt) {
                                ...
                                for ($i = 0; $i < $len; ++$i) {
                                    $ord = ord($txt[$i]);
                                    if (((0x21 <= $ord) && ($ord <= 0x3A)) || $ord === 0x3C || ((0x3E <= $ord) && (
                                            $ord <= 0x7E))) {
                                        $line. = $txt[$i];
                                    } else {
                            ...
                            function DKIM_Add($headers_line, $subject, $body) {
                                ...
                                foreach($headerLines as $headerLine) {
                                    ...
                                    if (preg_match('/^([^ \t]*?)(?::[ \t]*)(.*)$/', $headerLine, $matches)) {
                                        if ($currentHeaderLabel !== '') {
                                            ...
                                            $parsedHeaders[] = ['label' => $currentHeaderLabel, 'value' =>
                                                $currentHeaderValue
                                            ];
                                        }
                                    ...
                                    foreach($copiedHeaders as $copiedHeader) {
                                        ...
                                        if (strlen($copiedHeader) > self::STD_LINE_LENGTH - 3) {
                                            $copiedHeaderFields. = substr(
                                                chunk_split($copiedHeader, self::STD_LINE_LENGTH - 3, static::
                                                    $LE.self::FWS),
                                                0,
                                ...
                                $headerKeys = ' h='.implode(':', $headersToSignKeys).
                                ';'.static::$LE;
                                ...
                                $signature = trim(chunk_split($signature, self::STD_LINE_LENGTH - 3, static::$LE.self::
                                    FWS));
